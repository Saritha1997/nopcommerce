...
class Test_02_Admin_Login_data_driven:
    ...
    def test_verify_admin_login_data_driven(self, setup):
        self.driver = setup
        ...
        if "Fail" in self.status_list:
            self.logger.info("Test Admin Data Driven Test Failed")
            assert False
        else:
            self.logger.info("Test Admin Data Driven Test Passed")
            assert True
